...
<h3 align="center">审批记录列表</h3>
<div align="right">
  <input type="button" onclick="exportApply()" value="导出已审批通过记录"/>
</div>
<table align="center" border="1">
  ...
  <c:forEach items="${applyList}" var="course" varStatus="status">
    <tr>
      <td>${status.index+1}</td>
      <td>${course.courseid}</td>
      <td>${course.studentid}</td>
      <td>${course.reason}</td>
      <td>${course.statement}</td>
