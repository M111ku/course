...
<div align="center">
    <form action="searchApply" method="get">
        ...
        <label for="studentId">申请状态:</label>
...
<div class="pagination">
    <c:set var="numLinks" value="${totalCount / 2 + 1}" />
    <ul>
        <c:forEach begin="1" end="${numLinks}" var="i">
            <li class="<c:if test='${currentPage == i}'>active</c:if>"><a href="applyCheck?currentPage=${i}&pageSize=${2}">${i}</a></li>
        </c:forEach>
    </ul>
</div>
</body>
